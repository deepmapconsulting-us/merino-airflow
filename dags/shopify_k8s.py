...
REGION = "us-west2"
SHOPIFY_IMAGE = f"{REGION}-docker.pkg.dev/{PROJECT_ID}/merino/merino-shopify-cli:0.1.7"
AIRFLOW_NAMESPACE = "airflow"
TASK_RUNNER_KSA = "merino-airflow-task-runner"
POSTGRES_CONN_ID = "merino_analytics"
POSTGRES_DB = "merino-analytics"
GOOGLE_GEOCODING_SECRET = "merino-airflow-google-geocoding-api-key"
GOOGLE_GEOCODING_SECRET_KEY = "api-key"
SHOPIFY_CREDENTIALS_SECRET = "shopify-client-credentials"
SHOPIFY_STORE = "0dbe0e-2.myshopify.com"
...
def shopify_pod_env() -> list[k8s.V1EnvVar]:
    ...
    return [
        ...
        k8s.V1EnvVar(name="SHOPIFY_SHOP", value=SHOPIFY_STORE),
        k8s.V1EnvVar(name="SHOPIFY_API_VERSION", value=SHOPIFY_API_VERSION),
        k8s.V1EnvVar(
            name="SHOPIFY_CLIENT_ID",
            value_from=k8s.V1EnvVarSource(
                secret_key_ref=k8s.V1SecretKeySelector(
                    name=SHOPIFY_CREDENTIALS_SECRET,
                    key="client-id",
                ),
            ),
        ),
...
def shopify_import_pod(
    *,
    ...
    """Launch one Shopify batch pod with app credentials + Postgres env."""
